package com.buy.app.apigateway.filter;
...
import org.springframework.cloud.gateway.fileter.factory.AbstractGatewayFilterFactory;
import org.springframework.http.HttpStatus;
import org.springframework.http.server.reactive.ServerHttpRequest;
import org.springframework.http.server.reactive.ServerHttpResponse;
import org.springframework.stereotype.Component;
import org.springframework.web.server.ServerWebExchange;
import reactor.core.publisher.Mono; // Not sure about this one
...
public class JwtAuthenticationGatewayFilterFactory extends AbstractGatewayFilterFactory<Object> {
    ...
    @Value("${application.security.jwt.seceret-key}")
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ...
            Claims claimc = extrectClaim(token);
